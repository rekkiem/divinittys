...
export default function ProductForm({ categories, brands, initialData }: ProductFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!form.basePrice)  { toast.error('El precio es requerido'); return; }
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input type="text" value={form.sku} onChange={e => set('sku', e.target.value)}
                  placeholder="Auto-generado" className={fieldCls} />
              </div>
              <div>
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                {form.tags.map((tag: string) => (
                  <span key={tag} className="inline-flex items-center gap-1 px-2.5 py-1 bg-champagne-100 text-charcoal-600 rounded-full text-xs font-sans">
                    {tag}
            ...
            <div className="grid grid-cols-3 gap-4">
              <div>
                ...
                <input type="number" value={form.basePrice} onChange={e => set('basePrice', e.target.value)}
                  required min="0" step="1" placeholder="9990" className={fieldCls} />
              </div>
              <div>
                ...
                <input type="number" value={form.comparePrice} onChange={e => set('comparePrice', e.target.value)}
                  min="0" step="1" placeholder="14990" className={fieldCls} />
              </div>
              <div>
